...
namespace ComplianceWala.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260515135158_InitialSchema")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ComplianceWala.Domain.Entities.ReconciliationSession", b =>
                {
                    ...
                    b.HasIndex("BusinessGstin")
                        .HasDatabaseName("ix_reconciliation_sessions_gstin");

                    b.HasIndex("BusinessGstin", "FilingPeriod")
                        .HasDatabaseName("ix_reconciliation_sessions_gstin_period");

                    b.ToTable("reconciliation_sessions", (string)null);
                });
            ...
            modelBuilder.Entity("session_gstr2b_invoices", b =>
                {
                    ...
                    b.HasKey("session_id", "invoice_id");

                    b.HasIndex("invoice_id")
                        .HasDatabaseName("ix_session_gstr2b_invoices_invoice_id");

                    b.ToTable("session_gstr2b_invoices");
                });

            modelBuilder.Entity("session_purchase_invoices", b =>
                {
                    b.Property<Guid>("session_id")
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("session_purchase_invoices");
                });
            ...
            modelBuilder.Entity("session_gstr2b_invoices", b =>
                {
                    b.HasOne("ComplianceWala.Domain.Entities.Invoice", null)
                        .WithMany()
